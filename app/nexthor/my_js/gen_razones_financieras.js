function fncMostrar()
{
	div=document.getElementById("divRazones");
	...
	strParam="empresa="+empresa+"&periodoContable="+periodoContable;
	ajax_dynamic_div("POST",'gen_razones_financieras_get.php',strParam,div,'false');
}
