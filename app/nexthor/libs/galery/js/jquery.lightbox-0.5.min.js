 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'nexthor/libs/galery/images/lightbox-ico-loading.gif',imageBtnPrev:'nexthor/libs/galery/images/lightbox-btn-prev.gif',imageBtnNext:'nexthor/libs/galery/images/lightbox-btn-next.gif',imageBlank:'nexthor/libs/galery/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Imagen',txtOf:'de',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
