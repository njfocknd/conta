		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cuenta_mayor_auxiliarview.php")
...
var CurrentForm = fcuenta_mayor_auxiliaradd = new ew_Form("fcuenta_mayor_auxiliaradd", "add");
...
fcuenta_mayor_auxiliaradd.Lists["x_idcuenta_mayor_principal"] = {"LinkField":"x_idcuenta_mayor_principal","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
?>
<form name="fcuenta_mayor_auxiliaradd" id="fcuenta_mayor_auxiliaradd" class="<?php echo $cuenta_mayor_auxiliar_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cuenta_mayor_auxiliar_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
