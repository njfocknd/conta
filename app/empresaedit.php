...
<select data-table="empresa" data-field="x_estado" data-value-separator="<?php echo ew_HtmlEncode(is_array($empresa->estado->DisplayValueSeparator) ? json_encode($empresa->estado->DisplayValueSeparator) : $empresa->estado->DisplayValueSeparator) ?>" id="x_estado" name="x_estado"<?php echo $empresa->estado->EditAttributes() ?>>
<?php
if (is_array($empresa->estado->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = ew_SameStr($empresa->estado->CurrentValue, $arwrk[$rowcntwrk][0]) ? " selected" : "";
		if ($selwrk <> "") $emptywrk = FALSE;		
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $empresa->estado->DisplayValue($arwrk[$rowcntwrk]) ?>
</option>
<?php
	}
	if ($emptywrk && strval($empresa->estado->CurrentValue) <> "") {
?>
<option value="<?php echo ew_HtmlEncode($empresa->estado->CurrentValue) ?>" selected><?php echo $empresa->estado->CurrentValue ?></option>
<?php
    }
}
?>
