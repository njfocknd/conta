		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "empleadoview.php")
...
// Page object
var empleado_add = new ew_Page("empleado_add");
empleado_add.PageID = "add"; // Page ID
var EW_PAGE_ID = empleado_add.PageID; // For backward compatibility

// Form object
var fempleadoadd = new ew_Form("fempleadoadd");
...
fempleadoadd.Lists["x_idpersona"] = {"LinkField":"x_idpersona","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellido","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fempleadoadd.Lists["x_idempresa"] = {"LinkField":"x_idempresa","Ajax":null,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fempleadoadd" id="fempleadoadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
if (is_array($empleado->idpersona->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($empleado->idpersona->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<script type="text/javascript">
fempleadoadd.Lists["x_idempresa"].Options = <?php echo (is_array($empleado->idempresa->EditValue)) ? ew_ArrayToJson($empleado->idempresa->EditValue, 1) : "[]" ?>;
</script>
</span>
