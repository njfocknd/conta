...
function fncMostrar(){
	...
	str_param="capital="+capital+"&periodo="+periodo+"&tasa="+tasa+"&interesSimple=1";
	ajax_dynamic_div("POST",'interes_get.php',str_param,div);
	str_param2="capital="+capital+"&periodo="+periodo+"&tasa="+tasa+"&interesCompuesto=1";
	ajax_dynamic_div("POST",'interes_get.php',str_param2,div2);
	str_param3="capital="+capital+"&periodo="+periodo+"&tasa="+tasa+"&grafica=1";
	ajax_dynamic_div("POST",'interes_get.php',str_param3,div3);
}
</script>
<body>
					...
					<table style="width:100%;">
						<tr>
							<td>
								...
								<input type="text" name="capital" id="capital" value="100" class="form-control" style = 'width:100px;text-align:right'>
							</td>
							<td>
								cantidad de años:<br/>
							...
							<td>
								...
								<input type="text" name="tasa" id="tasa" value="10" class="form-control" style = 'width:100px;text-align:right'> %
							</td>
							<td>
