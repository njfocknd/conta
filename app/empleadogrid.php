...
// Form object
var fempleadogrid = new ew_Form("fempleadogrid", "grid");
...
fempleadogrid.Lists["x_idempresa"] = {"LinkField":"x_idempresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
if ($empleado->CurrentAction == "gridadd") {
	if ($empleado->CurrentMode == "copy") {
		$bSelectLimit = $empleado_grid->UseSelectLimit;
		if ($bSelectLimit) {
	...
	$bSelectLimit = $empleado_grid->UseSelectLimit;
	if ($bSelectLimit) {
		if ($empleado_grid->TotalRecs <= 0)
			$empleado_grid->TotalRecs = $empleado->SelectRecordCount();
	} else {
		if (!$empleado_grid->Recordset && ($empleado_grid->Recordset = $empleado_grid->LoadRecordset()))
			$empleado_grid->TotalRecs = $empleado_grid->Recordset->RecordCount();
	}
	$empleado_grid->StartRec = 1;
...
// Header row
$empleado_grid->RowType = EW_ROWTYPE_HEADER;
...
<input type="text" data-table="empleado" data-field="x_nit" name="x<?php echo $empleado_grid->RowIndex ?>_nit" id="x<?php echo $empleado_grid->RowIndex ?>_nit" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($empleado->nit->getPlaceHolder()) ?>" value="<?php echo $empleado->nit->EditValue ?>"<?php echo $empleado->nit->EditAttributes() ?>>
</span>
<input type="hidden" data-table="empleado" data-field="x_nit" name="o<?php echo $empleado_grid->RowIndex ?>_nit" id="o<?php echo $empleado_grid->RowIndex ?>_nit" value="<?php echo ew_HtmlEncode($empleado->nit->OldValue) ?>">
<?php } ?>
...
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_nit" class="empleado_nit">
<span<?php echo $empleado->nit->ViewAttributes() ?>>
<?php echo $empleado->nit->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="empleado" data-field="x_nit" name="x<?php echo $empleado_grid->RowIndex ?>_nit" id="x<?php echo $empleado_grid->RowIndex ?>_nit" value="<?php echo ew_HtmlEncode($empleado->nit->FormValue) ?>">
<input type="hidden" data-table="empleado" data-field="x_nit" name="o<?php echo $empleado_grid->RowIndex ?>_nit" id="o<?php echo $empleado_grid->RowIndex ?>_nit" value="<?php echo ew_HtmlEncode($empleado->nit->OldValue) ?>">
<?php } ?>
<a id="<?php echo $empleado_grid->PageObjName . "_row_" . $empleado_grid->RowCnt ?>"></a></td>
	<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="empleado" data-field="x_idempleado" name="x<?php echo $empleado_grid->RowIndex ?>_idempleado" id="x<?php echo $empleado_grid->RowIndex ?>_idempleado" value="<?php echo ew_HtmlEncode($empleado->idempleado->CurrentValue) ?>">
<input type="hidden" data-table="empleado" data-field="x_idempleado" name="o<?php echo $empleado_grid->RowIndex ?>_idempleado" id="o<?php echo $empleado_grid->RowIndex ?>_idempleado" value="<?php echo ew_HtmlEncode($empleado->idempleado->OldValue) ?>">
<?php } ?>
...
<input type="text" data-table="empleado" data-field="x_codigo" name="x<?php echo $empleado_grid->RowIndex ?>_codigo" id="x<?php echo $empleado_grid->RowIndex ?>_codigo" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($empleado->codigo->getPlaceHolder()) ?>" value="<?php echo $empleado->codigo->EditValue ?>"<?php echo $empleado->codigo->EditAttributes() ?>>
</span>
<input type="hidden" data-table="empleado" data-field="x_codigo" name="o<?php echo $empleado_grid->RowIndex ?>_codigo" id="o<?php echo $empleado_grid->RowIndex ?>_codigo" value="<?php echo ew_HtmlEncode($empleado->codigo->OldValue) ?>">
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_codigo" class="form-group empleado_codigo">
<input type="text" data-table="empleado" data-field="x_codigo" name="x<?php echo $empleado_grid->RowIndex ?>_codigo" id="x<?php echo $empleado_grid->RowIndex ?>_codigo" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($empleado->codigo->getPlaceHolder()) ?>" value="<?php echo $empleado->codigo->EditValue ?>"<?php echo $empleado->codigo->EditAttributes() ?>>
...
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_codigo" class="empleado_codigo">
<span<?php echo $empleado->codigo->ViewAttributes() ?>>
<?php echo $empleado->codigo->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="empleado" data-field="x_codigo" name="x<?php echo $empleado_grid->RowIndex ?>_codigo" id="x<?php echo $empleado_grid->RowIndex ?>_codigo" value="<?php echo ew_HtmlEncode($empleado->codigo->FormValue) ?>">
<input type="hidden" data-table="empleado" data-field="x_codigo" name="o<?php echo $empleado_grid->RowIndex ?>_codigo" id="o<?php echo $empleado_grid->RowIndex ?>_codigo" value="<?php echo ew_HtmlEncode($empleado->codigo->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<input type="text" data-table="empleado" data-field="x_nombre" name="x<?php echo $empleado_grid->RowIndex ?>_nombre" id="x<?php echo $empleado_grid->RowIndex ?>_nombre" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($empleado->nombre->getPlaceHolder()) ?>" value="<?php echo $empleado->nombre->EditValue ?>"<?php echo $empleado->nombre->EditAttributes() ?>>
</span>
<input type="hidden" data-table="empleado" data-field="x_nombre" name="o<?php echo $empleado_grid->RowIndex ?>_nombre" id="o<?php echo $empleado_grid->RowIndex ?>_nombre" value="<?php echo ew_HtmlEncode($empleado->nombre->OldValue) ?>">
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_nombre" class="form-group empleado_nombre">
<input type="text" data-table="empleado" data-field="x_nombre" name="x<?php echo $empleado_grid->RowIndex ?>_nombre" id="x<?php echo $empleado_grid->RowIndex ?>_nombre" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($empleado->nombre->getPlaceHolder()) ?>" value="<?php echo $empleado->nombre->EditValue ?>"<?php echo $empleado->nombre->EditAttributes() ?>>
...
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_nombre" class="empleado_nombre">
<span<?php echo $empleado->nombre->ViewAttributes() ?>>
<?php echo $empleado->nombre->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="empleado" data-field="x_nombre" name="x<?php echo $empleado_grid->RowIndex ?>_nombre" id="x<?php echo $empleado_grid->RowIndex ?>_nombre" value="<?php echo ew_HtmlEncode($empleado->nombre->FormValue) ?>">
<input type="hidden" data-table="empleado" data-field="x_nombre" name="o<?php echo $empleado_grid->RowIndex ?>_nombre" id="o<?php echo $empleado_grid->RowIndex ?>_nombre" value="<?php echo ew_HtmlEncode($empleado->nombre->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<select data-table="empleado" data-field="x_idempresa" data-value-separator="<?php echo ew_HtmlEncode(is_array($empleado->idempresa->DisplayValueSeparator) ? json_encode($empleado->idempresa->DisplayValueSeparator) : $empleado->idempresa->DisplayValueSeparator) ?>" id="x<?php echo $empleado_grid->RowIndex ?>_idempresa" name="x<?php echo $empleado_grid->RowIndex ?>_idempresa"<?php echo $empleado->idempresa->EditAttributes() ?>>
<?php
...
?>
<input type="hidden" name="s_x<?php echo $empleado_grid->RowIndex ?>_idempresa" id="s_x<?php echo $empleado_grid->RowIndex ?>_idempresa" value="<?php echo $empleado->idempresa->LookupFilterQuery() ?>">
</span>
<input type="hidden" data-table="empleado" data-field="x_idempresa" name="o<?php echo $empleado_grid->RowIndex ?>_idempresa" id="o<?php echo $empleado_grid->RowIndex ?>_idempresa" value="<?php echo ew_HtmlEncode($empleado->idempresa->OldValue) ?>">
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_idempresa" class="form-group empleado_idempresa">
<select data-table="empleado" data-field="x_idempresa" data-value-separator="<?php echo ew_HtmlEncode(is_array($empleado->idempresa->DisplayValueSeparator) ? json_encode($empleado->idempresa->DisplayValueSeparator) : $empleado->idempresa->DisplayValueSeparator) ?>" id="x<?php echo $empleado_grid->RowIndex ?>_idempresa" name="x<?php echo $empleado_grid->RowIndex ?>_idempresa"<?php echo $empleado->idempresa->EditAttributes() ?>>
...
<?php } ?>
<?php if ($empleado->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $empleado_grid->RowCnt ?>_empleado_idempresa" class="empleado_idempresa">
<span<?php echo $empleado->idempresa->ViewAttributes() ?>>
<?php echo $empleado->idempresa->ListViewValue() ?></span>
</span>
<input type="hidden" data-table="empleado" data-field="x_idempresa" name="x<?php echo $empleado_grid->RowIndex ?>_idempresa" id="x<?php echo $empleado_grid->RowIndex ?>_idempresa" value="<?php echo ew_HtmlEncode($empleado->idempresa->FormValue) ?>">
<input type="hidden" data-table="empleado" data-field="x_idempresa" name="o<?php echo $empleado_grid->RowIndex ?>_idempresa" id="o<?php echo $empleado_grid->RowIndex ?>_idempresa" value="<?php echo ew_HtmlEncode($empleado->idempresa->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
