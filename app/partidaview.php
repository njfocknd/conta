...
$partida_view = NULL; // Initialize page object first

class cpartida_view extends cpartida {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idpartida"] <> "") {
			$this->RecKey["idpartida"] = $_GET["idpartida"];
			$KeyUrl .= "&amp;idpartida=" . urlencode($this->RecKey["idpartida"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idpartida"] <> "") {
				...
				$this->RecKey["idpartida"] = $this->idpartida->QueryStringValue;
			} elseif (@$_POST["idpartida"] <> "") {
				$this->idpartida->setFormValue($_POST["idpartida"]);
				$this->RecKey["idpartida"] = $this->idpartida->FormValue;
			} else {
				$sReturnUrl = "partidalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "partidalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "partidalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($partida_view)) $partida_view = new cpartida_view();

// Page init
$partida_view->Page_Init();

// Page main
$partida_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$partida_view->Page_Render();
?>
...
var CurrentForm = fpartidaview = new ew_Form("fpartidaview", "view");

// Form_CustomValidate event
fpartidaview.Form_CustomValidate = 
...
fpartidaview.ValidateRequired = true;
<?php } else { ?>
fpartidaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fpartidaview.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpartidaview.Lists["x_estado"].Options = <?php echo json_encode($partida->estado->Options()) ?>;
...
<?php $partida_view->ExportOptions->Render("body") ?>
<?php
	foreach ($partida_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $partida_view->ShowPageHeader(); ?>
<?php
$partida_view->ShowMessage();
?>
<form name="fpartidaview" id="fpartidaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($partida_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $partida_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="partida">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($partida->idpartida->Visible) { // idpartida ?>
	<tr id="r_idpartida">
		<td><span id="elh_partida_idpartida"><?php echo $partida->idpartida->FldCaption() ?></span></td>
...
<?php echo $partida->idpartida->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_partida_fecha"><?php echo $partida->fecha->FldCaption() ?></span></td>
...
<?php echo $partida->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->idcuenta_cargo->Visible) { // idcuenta_cargo ?>
	<tr id="r_idcuenta_cargo">
		<td><span id="elh_partida_idcuenta_cargo"><?php echo $partida->idcuenta_cargo->FldCaption() ?></span></td>
...
<?php echo $partida->idcuenta_cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->idcuenta_abono->Visible) { // idcuenta_abono ?>
	<tr id="r_idcuenta_abono">
		<td><span id="elh_partida_idcuenta_abono"><?php echo $partida->idcuenta_abono->FldCaption() ?></span></td>
...
<?php echo $partida->idcuenta_abono->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_partida_monto"><?php echo $partida->monto->FldCaption() ?></span></td>
...
<?php echo $partida->monto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_partida_estado"><?php echo $partida->estado->FldCaption() ?></span></td>
...
<?php echo $partida->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($partida->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_partida_descripcion"><?php echo $partida->descripcion->FldCaption() ?></span></td>
...
<?php echo $partida->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
