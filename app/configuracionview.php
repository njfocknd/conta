...
$configuracion_view = NULL; // Initialize page object first

class cconfiguracion_view extends cconfiguracion {
	...
	// Page object name
	var $PageObjName = 'configuracion_view';
	...
	function __construct() {
		...
		if (@$_GET["idconfiguracion"] <> "") {
			$this->RecKey["idconfiguracion"] = $_GET["idconfiguracion"];
			$KeyUrl .= "&amp;idconfiguracion=" . urlencode($this->RecKey["idconfiguracion"]);
		}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "configuracionlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "configuracionlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($configuracion_view)) $configuracion_view = new cconfiguracion_view();

// Page init
$configuracion_view->Page_Init();

// Page main
$configuracion_view->Page_Main();
...
fconfiguracionview.ValidateRequired = true;
<?php } else { ?>
fconfiguracionview.ValidateRequired = false; 
<?php } ?>
...
<?php $configuracion_view->ExportOptions->Render("body") ?>
<?php
	foreach ($configuracion_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $configuracion_view->ShowPageHeader(); ?>
<?php
$configuracion_view->ShowMessage();
?>
<form name="fconfiguracionview" id="fconfiguracionview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($configuracion_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $configuracion_view->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fconfiguracionview.Init();
</script>
<?php
$configuracion_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
