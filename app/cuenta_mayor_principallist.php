...
<?php if ($cuenta_mayor_principal->estado->Visible) { // estado ?>
	...
	<?php } else { ?>
		<th data-name="estado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cuenta_mayor_principal->SortUrl($cuenta_mayor_principal->estado) ?>',1);"><div id="elh_cuenta_mayor_principal_estado" class="cuenta_mayor_principal_estado">
...
<?php
	...
	if ($cuenta_mayor_principal->CurrentAction <> "gridadd")
		$cuenta_mayor_principal_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
