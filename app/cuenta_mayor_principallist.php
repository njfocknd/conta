...
<?php if ($cuenta_mayor_principal->nomenclatura->Visible) { // nomenclatura ?>
	...
	<?php } else { ?>
		<th data-name="nomenclatura"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cuenta_mayor_principal->SortUrl($cuenta_mayor_principal->nomenclatura) ?>',1);"><div id="elh_cuenta_mayor_principal_nomenclatura" class="cuenta_mayor_principal_nomenclatura">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $cuenta_mayor_principal->nomenclatura->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($cuenta_mayor_principal->nomenclatura->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($cuenta_mayor_principal->nomenclatura->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
