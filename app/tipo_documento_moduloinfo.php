...
$tipo_documento_modulo = NULL;

//
// Table class for tipo_documento_modulo
//
class ctipo_documento_modulo extends cTable {
	var $idtipo_documento_modulo;
	...
	// Master filter
	function SqlMasterFilter_modulo() {
		return "`idmodulo`=@idmodulo@";
	}

	// Detail filter
	function SqlDetailFilter_modulo() {
		return "`idmodulo`=@idmodulo@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tipo_documento_modulo`";
	}
	...
	function SqlKeyFilter() {
		return "`idtipo_documento_modulo` = @idtipo_documento_modulo@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tipo_documento_modulolist.php";
		}
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->idtipo_documento_modulo->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// idtipo_documento_modulo
		$this->idtipo_documento_modulo->EditAttrs["class"] = "form-control";
		$this->idtipo_documento_modulo->EditCustomAttributes = "";
		$this->idtipo_documento_modulo->EditValue = $this->idtipo_documento_modulo->CurrentValue;
		$this->idtipo_documento_modulo->ViewCustomAttributes = "";
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->idtipo_documento_modulo->Exportable) $Doc->ExportCaption($this->idtipo_documento_modulo);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->idtipo_documento_modulo->Exportable) $Doc->ExportField($this->idtipo_documento_modulo);
