...
fcuentadelete.Lists["x_idsubcuenta"] = {"LinkField":"x_idsubcuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($cuenta->nomenclatura->Visible) { // nomenclatura ?>
		<th><span id="elh_cuenta_nomenclatura" class="cuenta_nomenclatura"><?php echo $cuenta->nomenclatura->FldCaption() ?></span></th>
<?php } ?>
<?php if ($cuenta->nombre->Visible) { // nombre ?>
		<th><span id="elh_cuenta_nombre" class="cuenta_nombre"><?php echo $cuenta->nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($cuenta->idsubcuenta->Visible) { // idsubcuenta ?>
		<th><span id="elh_cuenta_idsubcuenta" class="cuenta_idsubcuenta"><?php echo $cuenta->idsubcuenta->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $cuenta_delete->RowCnt ?>_cuenta_nomenclatura" class="form-group cuenta_nomenclatura">
...
<span id="el<?php echo $cuenta_delete->RowCnt ?>_cuenta_nombre" class="form-group cuenta_nombre">
...
<span id="el<?php echo $cuenta_delete->RowCnt ?>_cuenta_idsubcuenta" class="form-group cuenta_idsubcuenta">
