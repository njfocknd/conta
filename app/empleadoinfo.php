...
class cempleado extends cTable {
	...
	function __construct() {
		...
		// nit
		$this->nit = new cField('empleado', 'empleado', 'x_nit', 'nit', '`nit`', '`nit`', 200, -1, FALSE, '`nit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nit'] = &$this->nit;

		// codigo
		$this->codigo = new cField('empleado', 'empleado', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// idpersona
		$this->idpersona = new cField('empleado', 'empleado', 'x_idpersona', 'idpersona', '`idpersona`', '`idpersona`', 3, -1, FALSE, '`idpersona`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// idempresa
		$this->idempresa = new cField('empleado', 'empleado', 'x_idempresa', 'idempresa', '`idempresa`', '`idempresa`', 3, -1, FALSE, '`idempresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("empleadoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("empleadoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "empleadoadd.php?" . $this->UrlParm($parm);
		else
			return "empleadoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("empleadoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("empleadoadd.php", $this->UrlParm($parm));
	}
