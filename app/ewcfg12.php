...
define("EW_RANDOM_KEY", '0tt8P333I41PoprI', TRUE); // Random key for encryption
...
#$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "nexthordb.cquvmppcukva.us-west-2.rds.amazonaws.com", "port" => 3306, "user" => "dbadmin", "pass" => "23Nexthor23", "db" => "contable", "qs" => "`", "qe" => "`");
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "contable", "qs" => "`", "qe" => "`");
