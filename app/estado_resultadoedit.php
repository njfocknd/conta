...
$estado_resultado_edit = NULL; // Initialize page object first

class cestado_resultado_edit extends cestado_resultado {
	...
	// Page object name
	var $PageObjName = 'estado_resultado_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idestado_resultado->CurrentValue == "")
			$this->Page_Terminate("estado_resultadolist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($estado_resultado_edit)) $estado_resultado_edit = new cestado_resultado_edit();

// Page init
$estado_resultado_edit->Page_Init();

// Page main
$estado_resultado_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estado_resultado_edit->Page_Render();
?>
...
var CurrentForm = festado_resultadoedit = new ew_Form("festado_resultadoedit", "edit");

// Validate form
festado_resultadoedit.Validate = function() {
...
festado_resultadoedit.Form_CustomValidate = 
...
festado_resultadoedit.ValidateRequired = true;
<?php } else { ?>
festado_resultadoedit.ValidateRequired = false; 
<?php } ?>
...
<?php $estado_resultado_edit->ShowPageHeader(); ?>
<?php
$estado_resultado_edit->ShowMessage();
?>
<form name="festado_resultadoedit" id="festado_resultadoedit" class="<?php echo $estado_resultado_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($estado_resultado_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $estado_resultado_edit->Token ?>">
<?php } ?>
...
<?php if ($estado_resultado->idestado_resultado->Visible) { // idestado_resultado ?>
	<div id="r_idestado_resultado" class="form-group">
		<label id="elh_estado_resultado_idestado_resultado" class="col-sm-2 control-label ewLabel"><?php echo $estado_resultado->idestado_resultado->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $estado_resultado->idestado_resultado->CellAttributes() ?>>
<span id="el_estado_resultado_idestado_resultado">
<span<?php echo $estado_resultado->idestado_resultado->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $estado_resultado->idestado_resultado->EditValue ?></p></span>
</span>
<input type="hidden" data-table="estado_resultado" data-field="x_idestado_resultado" name="x_idestado_resultado" id="x_idestado_resultado" value="<?php echo ew_HtmlEncode($estado_resultado->idestado_resultado->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $estado_resultado_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
festado_resultadoedit.Init();
</script>
<?php
$estado_resultado_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$estado_resultado_edit->Page_Terminate();
?>
