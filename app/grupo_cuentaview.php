...
// Page object
var grupo_cuenta_view = new ew_Page("grupo_cuenta_view");
grupo_cuenta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = grupo_cuenta_view.PageID; // For backward compatibility

// Form object
var fgrupo_cuentaview = new ew_Form("fgrupo_cuentaview");
...
fgrupo_cuentaview.Lists["x_idclase_cuenta"] = {"LinkField":"x_idclase_cuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($grupo_cuenta->idgrupo_cuenta->Visible) { // idgrupo_cuenta ?>
	<tr id="r_idgrupo_cuenta">
		...
		<td<?php echo $grupo_cuenta->idgrupo_cuenta->CellAttributes() ?>>
<span id="el_grupo_cuenta_idgrupo_cuenta" class="form-group">
...
<?php if ($grupo_cuenta->definicion->Visible) { // definicion ?>
	<tr id="r_definicion">
		...
		<td<?php echo $grupo_cuenta->definicion->CellAttributes() ?>>
<span id="el_grupo_cuenta_definicion" class="form-group">
...
<?php if ($grupo_cuenta->estado->Visible) { // estado ?>
	<tr id="r_estado">
		...
		<td<?php echo $grupo_cuenta->estado->CellAttributes() ?>>
<span id="el_grupo_cuenta_estado" class="form-group">
