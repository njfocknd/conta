...
class cclase_cuenta extends cTable {
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "clase_cuentalist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`clase_cuenta`";
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->idclase_cuenta->CurrentValue = $key;
