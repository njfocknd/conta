...
function fncMostrar(){
	...
	ajax_dynamic_div("POST",'valor_presente_get.php',str_param,div);
	...
	ajax_dynamic_div("POST",'valor_presente_get.php',str_param3,div3);
}
</script>
<body>
				...
				<center>
					<table style="width:100%;">
						<tr>
							<td>
								Valor Futuro:<br/>
								<input type="text" name="capital" id="capital" value="161.05" class="form-control" style = 'width:100px;text-align:right'>
							</td>
							<td>
								cantidad de años:<br/>
