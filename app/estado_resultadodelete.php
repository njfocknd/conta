...
$estado_resultado_delete = NULL; // Initialize page object first

class cestado_resultado_delete extends cestado_resultado {
	...
	// Page object name
	var $PageObjName = 'estado_resultado_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("estado_resultadolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in estado_resultado class, estado_resultadoinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("estado_resultadolist.php"); // Return to list
			}
		}
	}
	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$sThisKey .= $row['idestado_resultado'];
				$conn->raiseErrorFn = $GLOBALS["EW_ERROR_FN"];
...
// Create page object
if (!isset($estado_resultado_delete)) $estado_resultado_delete = new cestado_resultado_delete();

// Page init
$estado_resultado_delete->Page_Init();

// Page main
$estado_resultado_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estado_resultado_delete->Page_Render();
?>
...
var CurrentForm = festado_resultadodelete = new ew_Form("festado_resultadodelete", "delete");

// Form_CustomValidate event
festado_resultadodelete.Form_CustomValidate = 
...
festado_resultadodelete.ValidateRequired = true;
<?php } else { ?>
festado_resultadodelete.ValidateRequired = false; 
<?php } ?>
...
<?php $estado_resultado_delete->ShowPageHeader(); ?>
<?php
$estado_resultado_delete->ShowMessage();
?>
<form name="festado_resultadodelete" id="festado_resultadodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($estado_resultado_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $estado_resultado_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="estado_resultado">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($estado_resultado_delete->RecKeys as $key) { ?>
...
<?php if ($estado_resultado->idestado_resultado->Visible) { // idestado_resultado ?>
		<th><span id="elh_estado_resultado_idestado_resultado" class="estado_resultado_idestado_resultado"><?php echo $estado_resultado->idestado_resultado->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->idempresa->Visible) { // idempresa ?>
		<th><span id="elh_estado_resultado_idempresa" class="estado_resultado_idempresa"><?php echo $estado_resultado->idempresa->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->idperiodo_contable->Visible) { // idperiodo_contable ?>
		<th><span id="elh_estado_resultado_idperiodo_contable" class="estado_resultado_idperiodo_contable"><?php echo $estado_resultado->idperiodo_contable->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->venta_netas->Visible) { // venta_netas ?>
		<th><span id="elh_estado_resultado_venta_netas" class="estado_resultado_venta_netas"><?php echo $estado_resultado->venta_netas->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->costo_ventas->Visible) { // costo_ventas ?>
		<th><span id="elh_estado_resultado_costo_ventas" class="estado_resultado_costo_ventas"><?php echo $estado_resultado->costo_ventas->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->depreciacion->Visible) { // depreciacion ?>
		<th><span id="elh_estado_resultado_depreciacion" class="estado_resultado_depreciacion"><?php echo $estado_resultado->depreciacion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->interes_pagado->Visible) { // interes_pagado ?>
		<th><span id="elh_estado_resultado_interes_pagado" class="estado_resultado_interes_pagado"><?php echo $estado_resultado->interes_pagado->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->utilidad_gravable->Visible) { // utilidad_gravable ?>
		<th><span id="elh_estado_resultado_utilidad_gravable" class="estado_resultado_utilidad_gravable"><?php echo $estado_resultado->utilidad_gravable->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->impuestos->Visible) { // impuestos ?>
		<th><span id="elh_estado_resultado_impuestos" class="estado_resultado_impuestos"><?php echo $estado_resultado->impuestos->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->utilidad_neta->Visible) { // utilidad_neta ?>
		<th><span id="elh_estado_resultado_utilidad_neta" class="estado_resultado_utilidad_neta"><?php echo $estado_resultado->utilidad_neta->FldCaption() ?></span></th>
<?php } ?>
<?php if ($estado_resultado->dividendos->Visible) { // dividendos ?>
		<th><span id="elh_estado_resultado_dividendos" class="estado_resultado_dividendos"><?php echo $estado_resultado->dividendos->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
	...
	<tbody>
<?php
$estado_resultado_delete->RecCnt = 0;
$i = 0;
while (!$estado_resultado_delete->Recordset->EOF) {
	$estado_resultado_delete->RecCnt++;
	$estado_resultado_delete->RowCnt++;

	// Set row properties
	$estado_resultado->ResetAttrs();
	$estado_resultado->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$estado_resultado_delete->LoadRowValues($estado_resultado_delete->Recordset);

	// Render row
	$estado_resultado_delete->RenderRow();
?>
	<tr<?php echo $estado_resultado->RowAttributes() ?>>
<?php if ($estado_resultado->idestado_resultado->Visible) { // idestado_resultado ?>
		<td<?php echo $estado_resultado->idestado_resultado->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_idestado_resultado" class="estado_resultado_idestado_resultado">
...
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_idempresa" class="estado_resultado_idempresa">
...
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_idperiodo_contable" class="estado_resultado_idperiodo_contable">
...
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_venta_netas" class="estado_resultado_venta_netas">
...
<?php } ?>
<?php if ($estado_resultado->costo_ventas->Visible) { // costo_ventas ?>
		<td<?php echo $estado_resultado->costo_ventas->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_costo_ventas" class="estado_resultado_costo_ventas">
...
<?php } ?>
<?php if ($estado_resultado->depreciacion->Visible) { // depreciacion ?>
		<td<?php echo $estado_resultado->depreciacion->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_depreciacion" class="estado_resultado_depreciacion">
...
<?php } ?>
<?php if ($estado_resultado->interes_pagado->Visible) { // interes_pagado ?>
		<td<?php echo $estado_resultado->interes_pagado->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_interes_pagado" class="estado_resultado_interes_pagado">
...
<?php } ?>
<?php if ($estado_resultado->utilidad_gravable->Visible) { // utilidad_gravable ?>
		<td<?php echo $estado_resultado->utilidad_gravable->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_utilidad_gravable" class="estado_resultado_utilidad_gravable">
...
<?php } ?>
<?php if ($estado_resultado->impuestos->Visible) { // impuestos ?>
		<td<?php echo $estado_resultado->impuestos->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_impuestos" class="estado_resultado_impuestos">
...
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_utilidad_neta" class="estado_resultado_utilidad_neta">
...
<?php } ?>
<?php if ($estado_resultado->dividendos->Visible) { // dividendos ?>
		<td<?php echo $estado_resultado->dividendos->CellAttributes() ?>>
<span id="el<?php echo $estado_resultado_delete->RowCnt ?>_estado_resultado_dividendos" class="estado_resultado_dividendos">
...
<?php } ?>
<?php if ($estado_resultado->utilidades_retenidas->Visible) { // utilidades_retenidas ?>
		<td<?php echo $estado_resultado->utilidades_retenidas->CellAttributes() ?>>
...
<?php
	$estado_resultado_delete->Recordset->MoveNext();
}
$estado_resultado_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $estado_resultado_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
festado_resultadodelete.Init();
</script>
<?php
$estado_resultado_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$estado_resultado_delete->Page_Terminate();
?>
