...
$tipo_documento_edit = NULL; // Initialize page object first

class ctipo_documento_edit extends ctipo_documento {
	...
	// Page object name
	var $PageObjName = 'tipo_documento_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idtipo_documento->CurrentValue == "")
			$this->Page_Terminate("tipo_documentolist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($tipo_documento_edit)) $tipo_documento_edit = new ctipo_documento_edit();

// Page init
$tipo_documento_edit->Page_Init();

// Page main
$tipo_documento_edit->Page_Main();
...
ftipo_documentoedit.Form_CustomValidate = 
...
ftipo_documentoedit.ValidateRequired = true;
<?php } else { ?>
ftipo_documentoedit.ValidateRequired = false; 
<?php } ?>
...
<?php $tipo_documento_edit->ShowPageHeader(); ?>
<?php
...
<script type="text/javascript">
ftipo_documentoedit.Init();
</script>
<?php
$tipo_documento_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
