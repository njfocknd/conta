		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "correlativoview.php")
...
var CurrentForm = fcorrelativoadd = new ew_Form("fcorrelativoadd", "add");
...
fcorrelativoadd.Lists["x_idempresa"] = {"LinkField":"x_idempresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
?>
<form name="fcorrelativoadd" id="fcorrelativoadd" class="<?php echo $correlativo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $correlativo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
