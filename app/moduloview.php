...
class cmodulo_view extends cmodulo {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idmodulo"] <> "") {
			$this->RecKey["idmodulo"] = $_GET["idmodulo"];
			$KeyUrl .= "&amp;idmodulo=" . urlencode($this->RecKey["idmodulo"]);
		}
	...
	function Page_Init() {
		...
		$this->idmodulo->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
...
?>
<form name="fmoduloview" id="fmoduloview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($modulo_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $modulo_view->Token ?>">
<?php } ?>
...
<?php
	if (in_array("tipo_documento_modulo", explode(",", $modulo->getCurrentDetailTable())) && $tipo_documento_modulo->DetailView) {
?>
