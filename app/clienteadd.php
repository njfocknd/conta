		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "clienteview.php")
...
// Page object
var cliente_add = new ew_Page("cliente_add");
cliente_add.PageID = "add"; // Page ID
var EW_PAGE_ID = cliente_add.PageID; // For backward compatibility

// Form object
var fclienteadd = new ew_Form("fclienteadd");
...
fclienteadd.Lists["x_idpersona"] = {"LinkField":"x_idpersona","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fclienteadd.Lists["x_idempresa"] = {"LinkField":"x_idempresa","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fclienteadd" id="fclienteadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_nombre" name="x_nombre" id="x_nombre" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($cliente->nombre->PlaceHolder) ?>" value="<?php echo $cliente->nombre->EditValue ?>"<?php echo $cliente->nombre->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_direccion" name="x_direccion" id="x_direccion" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($cliente->direccion->PlaceHolder) ?>" value="<?php echo $cliente->direccion->EditValue ?>"<?php echo $cliente->direccion->EditAttributes() ?>>
</span>
...
<?php } else { ?>
<span id="el_cliente_idpersona">
<select data-field="x_idpersona" id="x_idpersona" name="x_idpersona"<?php echo $cliente->idpersona->EditAttributes() ?>>
<?php
...
<select data-field="x_idempresa" id="x_idempresa" name="x_idempresa"<?php echo $cliente->idempresa->EditAttributes() ?>>
<?php
