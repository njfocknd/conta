...
class cconfiguracion_list extends cconfiguracion {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->idconfiguracion->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->idconfiguracion->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		// Initialize
		$sFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->idconfiguracion->AdvancedSearch->ToJSON(), ","); // Field idconfiguracion
	...
	function RestoreFilterList() {
		...
		$this->idconfiguracion->AdvancedSearch->SearchValue = @$filter["x_idconfiguracion"];
		$this->idconfiguracion->AdvancedSearch->SearchOperator = @$filter["z_idconfiguracion"];
		$this->idconfiguracion->AdvancedSearch->SearchCondition = @$filter["v_idconfiguracion"];
		$this->idconfiguracion->AdvancedSearch->SearchValue2 = @$filter["y_idconfiguracion"];
		$this->idconfiguracion->AdvancedSearch->SearchOperator2 = @$filter["w_idconfiguracion"];
		$this->idconfiguracion->AdvancedSearch->Save();
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->idconfiguracion->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fconfiguracionlistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
...
var CurrentSearchForm = fconfiguracionlistsrch = new ew_Form("fconfiguracionlistsrch");
</script>
<script type="text/javascript">
...
<?php } ?>
<?php if ($configuracion_list->SearchOptions->Visible()) { ?>
<?php $configuracion_list->SearchOptions->Render("body") ?>
<?php } ?>
<?php if ($configuracion_list->FilterOptions->Visible()) { ?>
<?php $configuracion_list->FilterOptions->Render("body") ?>
<?php } ?>
...
?>
<?php if ($configuracion->Export == "" && $configuracion->CurrentAction == "") { ?>
<form name="fconfiguracionlistsrch" id="fconfiguracionlistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($configuracion_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="fconfiguracionlistsrch_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="configuracion">
	<div class="ewBasicSearch">
<div id="xsr_1" class="ewRow">
	<div class="ewQuickSearch input-group">
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($configuracion_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<input type="hidden" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo ew_HtmlEncode($configuracion_list->BasicSearch->getType()) ?>">
	<div class="input-group-btn">
		<button type="button" data-toggle="dropdown" class="btn btn-default"><span id="searchtype"><?php echo $configuracion_list->BasicSearch->getTypeNameShort() ?></span><span class="caret"></span></button>
		<ul class="dropdown-menu pull-right" role="menu">
			<li<?php if ($configuracion_list->BasicSearch->getType() == "") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this)"><?php echo $Language->Phrase("QuickSearchAuto") ?></a></li>
			<li<?php if ($configuracion_list->BasicSearch->getType() == "=") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'=')"><?php echo $Language->Phrase("QuickSearchExact") ?></a></li>
			<li<?php if ($configuracion_list->BasicSearch->getType() == "AND") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'AND')"><?php echo $Language->Phrase("QuickSearchAll") ?></a></li>
			<li<?php if ($configuracion_list->BasicSearch->getType() == "OR") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'OR')"><?php echo $Language->Phrase("QuickSearchAny") ?></a></li>
		</ul>
...
<?php if ($configuracion->codigo->Visible) { // codigo ?>
	<?php if ($configuracion->SortUrl($configuracion->codigo) == "") { ?>
		<th data-name="codigo"><div id="elh_configuracion_codigo" class="configuracion_codigo"><div class="ewTableHeaderCaption"><?php echo $configuracion->codigo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="codigo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $configuracion->SortUrl($configuracion->codigo) ?>',1);"><div id="elh_configuracion_codigo" class="configuracion_codigo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $configuracion->codigo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($configuracion->codigo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($configuracion->codigo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($configuracion->valor->Visible) { // valor ?>
	<?php if ($configuracion->SortUrl($configuracion->valor) == "") { ?>
		<th data-name="valor"><div id="elh_configuracion_valor" class="configuracion_valor"><div class="ewTableHeaderCaption"><?php echo $configuracion->valor->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="valor"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $configuracion->SortUrl($configuracion->valor) ?>',1);"><div id="elh_configuracion_valor" class="configuracion_valor">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $configuracion->valor->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($configuracion->valor->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($configuracion->valor->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($configuracion->descripcion->Visible) { // descripcion ?>
	<?php if ($configuracion->SortUrl($configuracion->descripcion) == "") { ?>
		<th data-name="descripcion"><div id="elh_configuracion_descripcion" class="configuracion_descripcion"><div class="ewTableHeaderCaption"><?php echo $configuracion->descripcion->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="descripcion"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $configuracion->SortUrl($configuracion->descripcion) ?>',1);"><div id="elh_configuracion_descripcion" class="configuracion_descripcion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $configuracion->descripcion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($configuracion->descripcion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($configuracion->descripcion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<span id="el<?php echo $configuracion_list->RowCnt ?>_configuracion_codigo" class="configuracion_codigo">
<span<?php echo $configuracion->codigo->ViewAttributes() ?>>
<?php echo $configuracion->codigo->ListViewValue() ?></span>
</span>
...
<span id="el<?php echo $configuracion_list->RowCnt ?>_configuracion_valor" class="configuracion_valor">
<span<?php echo $configuracion->valor->ViewAttributes() ?>>
<?php echo $configuracion->valor->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($configuracion->descripcion->Visible) { // descripcion ?>
		<td data-name="descripcion"<?php echo $configuracion->descripcion->CellAttributes() ?>>
<span id="el<?php echo $configuracion_list->RowCnt ?>_configuracion_descripcion" class="configuracion_descripcion">
...
<span id="el<?php echo $configuracion_list->RowCnt ?>_configuracion_idempresa" class="configuracion_idempresa">
...
<?php if ($configuracion_list->Pager->RecordCount > 0) { ?>
<div class="ewPager">
...
<?php } ?>
<script type="text/javascript">
fconfiguracionlistsrch.Init();
fconfiguracionlistsrch.FilterList = <?php echo $configuracion_list->GetFilterList() ?>;
