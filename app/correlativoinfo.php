...
//
// Table class for correlativo
//
class ccorrelativo extends cTable {
	var $idcorrelativo;
	var $codigo;
	var $valor;
	var $idempresa;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`correlativo`";
	}
	...
	function SqlKeyFilter() {
		return "`idcorrelativo` = @idcorrelativo@";
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->idcorrelativo->CurrentValue = $key;
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// idcorrelativo
		$this->idcorrelativo->EditAttrs["class"] = "form-control";
		$this->idcorrelativo->EditCustomAttributes = "";
		$this->idcorrelativo->EditValue = $this->idcorrelativo->CurrentValue;
		$this->idcorrelativo->ViewCustomAttributes = "";
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->idcorrelativo->Exportable) $Doc->ExportCaption($this->idcorrelativo);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->idcorrelativo->Exportable) $Doc->ExportField($this->idcorrelativo);
