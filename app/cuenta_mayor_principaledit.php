...
class ccuenta_mayor_principal_edit extends ccuenta_mayor_principal {
	...
	function ValidateForm() {
		...
		if (in_array("cuenta_mayor_auxiliar", $DetailTblVar) && $GLOBALS["cuenta_mayor_auxiliar"]->DetailEdit) {
		...
		if ($rs->EOF) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					...
					if (in_array("cuenta_mayor_auxiliar", $DetailTblVar) && $GLOBALS["cuenta_mayor_auxiliar"]->DetailEdit) {
						if (!isset($GLOBALS["cuenta_mayor_auxiliar_grid"])) $GLOBALS["cuenta_mayor_auxiliar_grid"] = new ccuenta_mayor_auxiliar_grid(); // Get detail page object
						$EditRow = $GLOBALS["cuenta_mayor_auxiliar_grid"]->GridUpdate();
					}
				}
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("cuenta_mayor_auxiliar", $DetailTblVar)) {
				...
				if ($GLOBALS["cuenta_mayor_auxiliar_grid"]->DetailEdit) {
					$GLOBALS["cuenta_mayor_auxiliar_grid"]->CurrentMode = "edit";
					$GLOBALS["cuenta_mayor_auxiliar_grid"]->CurrentAction = "gridedit";
...
// Page object
var cuenta_mayor_principal_edit = new ew_Page("cuenta_mayor_principal_edit");
cuenta_mayor_principal_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = cuenta_mayor_principal_edit.PageID; // For backward compatibility

// Form object
var fcuenta_mayor_principaledit = new ew_Form("fcuenta_mayor_principaledit");
...
fcuenta_mayor_principaledit.Lists["x_idsubgrupo_cuenta"] = {"LinkField":"x_idsubgrupo_cuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fcuenta_mayor_principaledit" id="fcuenta_mayor_principaledit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<select data-field="x_estado" id="x_estado" name="x_estado"<?php echo $cuenta_mayor_principal->estado->EditAttributes() ?>>
<?php
...
<input type="hidden" data-field="x_idcuenta_mayor_principal" name="x_idcuenta_mayor_principal" id="x_idcuenta_mayor_principal" value="<?php echo ew_HtmlEncode($cuenta_mayor_principal->idcuenta_mayor_principal->CurrentValue) ?>">
<?php
	if (in_array("cuenta_mayor_auxiliar", explode(",", $cuenta_mayor_principal->getCurrentDetailTable())) && $cuenta_mayor_auxiliar->DetailEdit) {
?>
