...
// Page object
var caja_chica_detalle_edit = new ew_Page("caja_chica_detalle_edit");
caja_chica_detalle_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = caja_chica_detalle_edit.PageID; // For backward compatibility

// Form object
var fcaja_chica_detalleedit = new ew_Form("fcaja_chica_detalleedit");
...
fcaja_chica_detalleedit.Lists["x_idcaja_chica"] = {"LinkField":"x_idcaja_chica","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fcaja_chica_detalleedit" id="fcaja_chica_detalleedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($caja_chica_detalle->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_caja_chica_detalle_estado" class="col-sm-2 control-label ewLabel"><?php echo $caja_chica_detalle->estado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $caja_chica_detalle->estado->CellAttributes() ?>>
<span id="el_caja_chica_detalle_estado">
<div id="tp_x_estado" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><input type="radio" name="x_estado" id="x_estado" value="{value}"<?php echo $caja_chica_detalle->estado->EditAttributes() ?>></div>
...
if (is_array($arwrk)) {
	...
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($caja_chica_detalle->estado->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;

		// Note: No spacing within the LABEL tag
?>
<?php echo ew_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label class="radio-inline"><input type="radio" data-field="x_estado" name="x_estado" id="x_estado_<?php echo $rowcntwrk ?>" value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $caja_chica_detalle->estado->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
<input type="hidden" data-field="x_idcaja_chica_detalle" name="x_idcaja_chica_detalle" id="x_idcaja_chica_detalle" value="<?php echo ew_HtmlEncode($caja_chica_detalle->idcaja_chica_detalle->CurrentValue) ?>">
