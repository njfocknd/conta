...
class csucursal_list extends csucursal {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->casa_matriz); // casa_matriz
...
fsucursallist.Lists["x_idpais"] = {"LinkField":"x_idpais","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($sucursal->casa_matriz->Visible) { // casa_matriz ?>
	...
	<?php } else { ?>
		<th data-name="casa_matriz"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->casa_matriz) ?>',1);"><div id="elh_sucursal_casa_matriz" class="sucursal_casa_matriz">
...
<?php if ($sucursal->idpais->Visible) { // idpais ?>
	...
	<?php } else { ?>
		<th data-name="idpais"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->idpais) ?>',1);"><div id="elh_sucursal_idpais" class="sucursal_idpais">
