...
$clase_cuenta_view = NULL; // Initialize page object first

class cclase_cuenta_view extends cclase_cuenta {
	...
	// Page object name
	var $PageObjName = 'clase_cuenta_view';
	...
	function __construct() {
		...
		if (@$_GET["idclase_cuenta"] <> "") {
			$this->RecKey["idclase_cuenta"] = $_GET["idclase_cuenta"];
			$KeyUrl .= "&amp;idclase_cuenta=" . urlencode($this->RecKey["idclase_cuenta"]);
		}
	...
	function Page_Init() {
		...
		$this->idclase_cuenta->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idclase_cuenta"] <> "") {
				...
				$this->RecKey["idclase_cuenta"] = $this->idclase_cuenta->QueryStringValue;
			} else {
				$sReturnUrl = "clase_cuentalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "clase_cuentalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "clase_cuentalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		// "detail_grupo_cuenta"
		$item = &$option->Add("detail_grupo_cuenta");
		...
		$links = "";
		if ($GLOBALS["grupo_cuenta_grid"] && $GLOBALS["grupo_cuenta_grid"]->DetailView) {
		...
		if ($GLOBALS["grupo_cuenta_grid"] && $GLOBALS["grupo_cuenta_grid"]->DetailEdit) {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("grupo_cuenta", $DetailTblVar)) {
				...
				if ($GLOBALS["grupo_cuenta_grid"]->DetailView) {
					$GLOBALS["grupo_cuenta_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($clase_cuenta_view)) $clase_cuenta_view = new cclase_cuenta_view();

// Page init
$clase_cuenta_view->Page_Init();

// Page main
$clase_cuenta_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$clase_cuenta_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var clase_cuenta_view = new ew_Page("clase_cuenta_view");
clase_cuenta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = clase_cuenta_view.PageID; // For backward compatibility

// Form object
var fclase_cuentaview = new ew_Form("fclase_cuentaview");

// Form_CustomValidate event
fclase_cuentaview.Form_CustomValidate = 
...
fclase_cuentaview.ValidateRequired = true;
<?php } else { ?>
fclase_cuentaview.ValidateRequired = false; 
<?php } ?>
...
<?php $clase_cuenta_view->ExportOptions->Render("body") ?>
<?php
	foreach ($clase_cuenta_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $clase_cuenta_view->ShowPageHeader(); ?>
<?php
$clase_cuenta_view->ShowMessage();
?>
<form name="fclase_cuentaview" id="fclase_cuentaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($clase_cuenta_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $clase_cuenta_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="clase_cuenta">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($clase_cuenta->idclase_cuenta->Visible) { // idclase_cuenta ?>
	<tr id="r_idclase_cuenta">
		<td><span id="elh_clase_cuenta_idclase_cuenta"><?php echo $clase_cuenta->idclase_cuenta->FldCaption() ?></span></td>
		<td<?php echo $clase_cuenta->idclase_cuenta->CellAttributes() ?>>
<span id="el_clase_cuenta_idclase_cuenta" class="form-group">
<span<?php echo $clase_cuenta->idclase_cuenta->ViewAttributes() ?>>
<?php echo $clase_cuenta->idclase_cuenta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $clase_cuenta->nomenclatura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($clase_cuenta->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_clase_cuenta_estado"><?php echo $clase_cuenta->estado->FldCaption() ?></span></td>
...
<?php
	if (in_array("grupo_cuenta", explode(",", $clase_cuenta->getCurrentDetailTable())) && $grupo_cuenta->DetailView) {
?>
...
<script type="text/javascript">
fclase_cuentaview.Init();
</script>
<?php
$clase_cuenta_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$clase_cuenta_view->Page_Terminate();
?>
