...
class ccuenta extends cTable {
	...
	function __construct() {
		...
		// nomenclatura
		$this->nomenclatura = new cField('cuenta', 'cuenta', 'x_nomenclatura', 'nomenclatura', '`nomenclatura`', '`nomenclatura`', 200, -1, FALSE, '`nomenclatura`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// debe
		$this->debe = new cField('cuenta', 'cuenta', 'x_debe', 'debe', '`debe`', '`debe`', 131, -1, FALSE, '`debe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->debe->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['debe'] = &$this->debe;

		// haber
		$this->haber = new cField('cuenta', 'cuenta', 'x_haber', 'haber', '`haber`', '`haber`', 131, -1, FALSE, '`haber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// idsubcuenta
		$this->idsubcuenta = new cField('cuenta', 'cuenta', 'x_idsubcuenta', 'idsubcuenta', '`idsubcuenta`', '`idsubcuenta`', 3, -1, FALSE, '`idsubcuenta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		if ($this->getCurrentMasterTable() == "subcuenta") {
			if ($this->idsubcuenta->getSessionValue() <> "")
				$sMasterFilter .= "`idsubcuenta`=" . ew_QuotedValue($this->idsubcuenta->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "subcuenta") {
			if ($this->idsubcuenta->getSessionValue() <> "")
				$sDetailFilter .= "`idsubcuenta`=" . ew_QuotedValue($this->idsubcuenta->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
