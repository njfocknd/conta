...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_nombre") && $objForm->HasValue("o_nombre") && $this->nombre->CurrentValue <> $this->nombre->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_idsubcuenta") && $objForm->HasValue("o_idsubcuenta") && $this->idsubcuenta->CurrentValue <> $this->idsubcuenta->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadDefaultValues() {
		...
		$this->idsubcuenta->OldValue = $this->idsubcuenta->CurrentValue;
	}
	...
	function LoadFormValues() {
		...
		$this->idsubcuenta->setOldValue($objForm->GetValue("o_idsubcuenta"));
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// idsubcuenta
			$this->idsubcuenta->SetDbValueDef($rsnew, $this->idsubcuenta->CurrentValue, 0, $this->idsubcuenta->ReadOnly);
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "subcuenta") {
			...
			if ($GLOBALS["subcuenta"]->EventCancelled) $this->EventCancelled = TRUE;
		}
