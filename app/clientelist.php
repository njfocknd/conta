...
<?php if ($cliente->codigo->Visible) { // codigo ?>
	...
	<?php } else { ?>
		<th data-name="codigo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->codigo) ?>',1);"><div id="elh_cliente_codigo" class="cliente_codigo">
...
<?php if ($cliente->nombre->Visible) { // nombre ?>
	...
	<?php } else { ?>
		<th data-name="nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->nombre) ?>',1);"><div id="elh_cliente_nombre" class="cliente_nombre">
...
<?php if ($cliente->idempresa->Visible) { // idempresa ?>
	...
	<?php } else { ?>
		<th data-name="idempresa"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $cliente->SortUrl($cliente->idempresa) ?>',1);"><div id="elh_cliente_idempresa" class="cliente_idempresa">
