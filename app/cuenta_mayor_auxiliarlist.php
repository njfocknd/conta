	...
	function RenderOtherOptions() {
		...
		if ($this->CurrentAction <> "gridadd" && $this->CurrentAction <> "gridedit") { // Not grid add/edit mode
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fcuenta_mayor_auxiliarlist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
...
// Page object
var cuenta_mayor_auxiliar_list = new ew_Page("cuenta_mayor_auxiliar_list");
cuenta_mayor_auxiliar_list.PageID = "list"; // Page ID
var EW_PAGE_ID = cuenta_mayor_auxiliar_list.PageID; // For backward compatibility
...
fcuenta_mayor_auxiliarlist.Lists["x_idcuenta_mayor_principal"] = {"LinkField":"x_idcuenta_mayor_principal","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

// Form object for search
var fcuenta_mayor_auxiliarlistsrch = new ew_Form("fcuenta_mayor_auxiliarlistsrch");
</script>
<script type="text/javascript">
...
<?php if ($cuenta_mayor_auxiliar_list->TotalRecs > 0 && $cuenta_mayor_auxiliar->getCurrentMasterTable() == "" && $cuenta_mayor_auxiliar_list->ExportOptions->Visible()) { ?>
...
?>
<?php if ($cuenta_mayor_auxiliar_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $cuenta_mayor_auxiliar_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php include_once $EW_RELATIVE_PATH . "cuenta_mayor_principalmaster.php" ?>
<?php
	}
}
?>
...
if ($cuenta_mayor_auxiliar->CurrentAction == "gridadd") {
	...
	if ($bSelectLimit) {
		...
		if ($cuenta_mayor_auxiliar_list->Recordset = $cuenta_mayor_auxiliar_list->LoadRecordset())
