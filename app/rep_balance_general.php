...
function fncMostrar()
{
	...
	strParam="varianza="+varianza+"&empresa="+empresa+"&periodoContable="+periodoContable+"&empresa2="+empresa2+"&periodoContable2="+periodoContable2+"&mostrarActivoCorriente=1";
	ajax_dynamic_div("POST",'rep_balance_general_get.php',strParam,div,'false');
}
</script>
<html lang="en-US">
<head>
...
<body>
	<div class="panel panel-info">
		<div class="panel-heading">
			<center>
				Análisis Horizontal del Balance General de
