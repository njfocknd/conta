...
INSERT INTO `banco` VALUES (1,'Banco Reformador','BANCOR','2016-04-11 14:06:14','Activo');
...
CREATE TABLE `banco_cuenta` (
  `idbanco_cuenta` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idbanco_cuenta`),
  KEY `fk_banco_cuenta_idbanco_idx` (`idbanco`),
  KEY `fk_banco_cuenta_idempresa_idx` (`idempresa`),
  CONSTRAINT `fk_banco_cuenta_idbanco` FOREIGN KEY (`idbanco`) REFERENCES `banco` (`idbanco`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_banco_cuenta_idempresa` FOREIGN KEY (`idempresa`) REFERENCES `empresa` (`idempresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `banco_cuenta` VALUES (1,'Cuenta principal','1111','Activo','2016-04-11 14:06:33',1,1);
...
CREATE TABLE `caja_chica` (
  `idcaja_chica` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  ...
  PRIMARY KEY (`idcaja_chica`),
  KEY `fk_caja_chica_idcuenta_idx` (`idcuenta`),
  KEY `fk_caja_chica_idempleado_idx` (`idempleado`),
  KEY `fk_caja_chica_idempresa_idx` (`idempresa`),
  CONSTRAINT `fk_caja_chica_idcuenta` FOREIGN KEY (`idcuenta`) REFERENCES `cuenta` (`idcuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_caja_chica_idempleado` FOREIGN KEY (`idempleado`) REFERENCES `empleado` (`idempleado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_caja_chica_idempresa` FOREIGN KEY (`idempresa`) REFERENCES `empresa` (`idempresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `caja_chica` VALUES (1,'Caja TI',5,NULL,'Activo',1,3,-1720.00),(2,'Gerencia',1,'2016-04-11 11:44:41','Activo',1,3,550.00),(3,'prueba 3',1,'2016-04-11 14:43:09','Activo',1,3,7500.00);
...
--
-- Table structure for table `caja_chica_aplicacion`
--

DROP TABLE IF EXISTS `caja_chica_aplicacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caja_chica_aplicacion` (
  `idcaja_chica_aplicacion` int(11) NOT NULL AUTO_INCREMENT,
  `idcaja_chica_detalle` int(11) NOT NULL DEFAULT '1',
  `idreferencia` int(11) DEFAULT NULL,
  `tabla_referencia` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `monto` decimal(10,2) NOT NULL DEFAULT '0.00',
  `fecha` date DEFAULT NULL,
  `fecha_insercion` datetime DEFAULT NULL,
  `estado` enum('Activo','Inactivo') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Activo',
  PRIMARY KEY (`idcaja_chica_aplicacion`),
  KEY `fk_caja_chica_aplicacion_caja_chica_detalle_idx` (`idcaja_chica_detalle`),
  CONSTRAINT `fk_caja_chica_aplicacion_caja_chica_detalle` FOREIGN KEY (`idcaja_chica_detalle`) REFERENCES `caja_chica_detalle` (`idcaja_chica_detalle`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `caja_chica_aplicacion`
--

LOCK TABLES `caja_chica_aplicacion` WRITE;
/*!40000 ALTER TABLE `caja_chica_aplicacion` DISABLE KEYS */;
INSERT INTO `caja_chica_aplicacion` VALUES (1,1,NULL,NULL,15.00,'2016-04-11',NULL,'Inactivo'),(2,1,NULL,NULL,50.00,'2016-04-11','2016-04-11 10:26:28','Inactivo'),(3,1,NULL,NULL,20.00,'2016-04-11','2016-04-11 10:27:56','Activo'),(4,1,NULL,NULL,10.00,'2016-04-11','2016-04-11 10:28:10','Activo'),(5,5,1,'documento_caja_chica',20.00,'2016-04-11','2016-04-11 11:25:32','Activo'),(6,8,2,'documento_caja_chica',300.00,'2016-04-11','2016-04-11 11:49:40','Activo'),(7,9,2,'documento_caja_chica',50.00,NULL,'2016-04-11 11:50:49','Activo'),(8,10,3,'documento_caja_chica',100.00,NULL,'2016-04-11 11:52:37','Activo'),(9,13,2,'caja_chica_cheque',2000.00,'2016-04-11','2016-04-11 14:41:56','Activo'),(10,14,3,'caja_chica_cheque',5000.00,'2016-04-11','2016-04-11 14:43:29','Activo'),(11,15,4,'caja_chica_cheque',2500.00,'2016-04-11','2016-04-11 15:13:53','Inactivo'),(12,16,5,'caja_chica_cheque',3000.00,'2016-04-11','2016-04-11 15:32:53','Inactivo');
/*!40000 ALTER TABLE `caja_chica_aplicacion` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
BEGIN
	...
	if new.estado != old.estado then
		if new.estado = 'Inactivo' then
			update caja_chica_detalle set monto_aplicado = monto_aplicado-old.monto where idcaja_chica_detalle = new.idcaja_chica_detalle;
        else 
    ...
    if new.estado = 'Activo' then
		if new.monto != old.monto then
			select ifnull(sum(monto),0) into s_monto_acumulado from caja_chica_aplicacion where idcaja_chica_detalle = new.idcaja_chica_detalle and estado = 1 and idcaja_chica_aplicacion != new.idcaja_chica_aplicacion;
			select ifnull(monto,0) into s_monto from caja_chica_detalle where idcaja_chica_detalle = new.idcaja_chica_detalle and estado = 1;
			if (s_monto_acumulado + new.monto) <= s_monto then
				update caja_chica_detalle set monto_aplicado = monto_aplicado + (new.monto -old.monto) where idcaja_chica_detalle = new.idcaja_chica_detalle;
			else
...
--
-- Table structure for table `caja_chica_cheque`
--

DROP TABLE IF EXISTS `caja_chica_cheque`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caja_chica_cheque` (
  `idcaja_chica_cheque` int(11) NOT NULL AUTO_INCREMENT,
  `idcaja_chica` int(11) NOT NULL DEFAULT '1',
  `fecha` date DEFAULT NULL,
  `monto` decimal(10,2) NOT NULL DEFAULT '0.00',
  `idbanco` int(11) NOT NULL DEFAULT '1',
  `idbanco_cuenta` int(11) NOT NULL DEFAULT '1',
  `estado` enum('Activo','Inactivo') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Activo',
  `fecha_insercion` datetime DEFAULT NULL,
  `numero` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `status` enum('Emitido','Autorizado','Cobrado','Rechazado','Anulado') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Emitido',
  PRIMARY KEY (`idcaja_chica_cheque`),
  KEY `fk_caja_chica_cheque_idbanco_idx` (`idbanco`),
  KEY `fk_caja_chica_cheque_idbanco_cuenta_idx` (`idbanco_cuenta`),
  KEY `fk_caja_chica_cheque_idcaja_chica_idx` (`idcaja_chica`),
  CONSTRAINT `fk_caja_chica_cheque_idbanco` FOREIGN KEY (`idbanco`) REFERENCES `banco` (`idbanco`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_caja_chica_cheque_idbanco_cuenta` FOREIGN KEY (`idbanco_cuenta`) REFERENCES `banco_cuenta` (`idbanco_cuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_caja_chica_cheque_idcaja_chica` FOREIGN KEY (`idcaja_chica`) REFERENCES `caja_chica` (`idcaja_chica`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `caja_chica_cheque`
--

LOCK TABLES `caja_chica_cheque` WRITE;
/*!40000 ALTER TABLE `caja_chica_cheque` DISABLE KEYS */;
INSERT INTO `caja_chica_cheque` VALUES (2,1,'2016-04-11',2000.00,1,1,'Activo','2016-04-11 14:41:56','23432','Emitido'),(3,3,'2016-04-11',5000.00,1,1,'Activo','2016-04-11 14:43:29','er23424','Emitido'),(4,3,'2016-04-11',2500.00,1,1,'Inactivo','2016-04-11 15:12:41','232342','Cobrado'),(5,3,'2016-04-11',3000.00,1,1,'Inactivo','2016-04-11 15:31:42','weqw','Cobrado');
/*!40000 ALTER TABLE `caja_chica_cheque` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
BEGIN
    ...
    if old.estado != new.estado then
		if new.estado = 'Inactivo' then
			update caja_chica_detalle set estado = 'Inactivo' where idreferencia = new.idcaja_chica_cheque and tabla_referencia =  'caja_chica_cheque';
			update caja_chica_aplicacion set estado = 'Inactivo' where idreferencia = new.idcaja_chica_cheque and tabla_referencia =  'caja_chica_cheque';
        else 
		...
		if old.status != new.status then
			if new.status = 'Cobrado' then
				if old.status = 'Autorizado' then
					INSERT INTO caja_chica_detalle (idcaja_chica, fecha, monto, tipo, fecha_insercion, estado, monto_aplicado, descripcion, idreferencia, tabla_referencia) VALUES (new.idcaja_chica, new.fecha, new.monto, 'Cargo', now(), 'Activo', '0', concat('Cheque de Caja Chica No.', new.numero), new.idcaja_chica_cheque, 'caja_chica_cheque');
					select idcaja_chica_detalle into s_idcaja_chica_detalle from caja_chica_detalle where idreferencia = new.idcaja_chica_cheque and tabla_referencia =  'caja_chica_cheque';
					INSERT INTO caja_chica_aplicacion (idcaja_chica_detalle, idreferencia, tabla_referencia, monto, fecha, fecha_insercion, estado) VALUES (s_idcaja_chica_detalle, new.idcaja_chica_cheque, 'caja_chica_cheque', new.monto, new.fecha, now(), 'Activo');
				else
					set new.status = old.status;
				end if;
			end if;
			if old.status = 'Anulado' or old.status = 'Cobrado' then
				set new.status = old.status;
			end if;
		end if;
	end if;
...
--
-- Table structure for table `caja_chica_detalle`
--

DROP TABLE IF EXISTS `caja_chica_detalle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `caja_chica_detalle` (
  `idcaja_chica_detalle` int(11) NOT NULL AUTO_INCREMENT,
  `idcaja_chica` int(11) NOT NULL DEFAULT '1',
  `fecha` date DEFAULT NULL,
  `monto` decimal(10,2) NOT NULL DEFAULT '0.00',
  `tipo` enum('Cargo','Abono') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Abono',
  `fecha_insercion` datetime DEFAULT NULL,
  `estado` enum('Activo','Inactivo') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Activo',
  `monto_aplicado` decimal(10,2) NOT NULL DEFAULT '0.00',
  `descripcion` varchar(128) COLLATE utf8_spanish_ci DEFAULT NULL,
  `idreferencia` int(11) NOT NULL DEFAULT '1',
  `tabla_referencia` varchar(45) COLLATE utf8_spanish_ci NOT NULL DEFAULT 'caja_chica_cheque',
  PRIMARY KEY (`idcaja_chica_detalle`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `caja_chica_detalle`
--

LOCK TABLES `caja_chica_detalle` WRITE;
/*!40000 ALTER TABLE `caja_chica_detalle` DISABLE KEYS */;
INSERT INTO `caja_chica_detalle` VALUES (1,1,'2016-04-06',100.00,'Cargo',NULL,'Activo',30.00,NULL,1,'caja_chica_cheque'),(2,1,'2016-04-06',50.00,'Abono',NULL,'Inactivo',0.00,NULL,1,'caja_chica_cheque'),(3,1,'2016-04-11',200.00,'Abono','2016-04-11 11:08:11','Inactivo',0.00,NULL,1,'caja_chica_cheque'),(4,1,'2016-04-11',200.00,'Cargo','2016-04-11 11:08:48','Activo',0.00,NULL,1,'caja_chica_cheque'),(5,1,'2016-04-11',20.00,'Abono','2016-04-11 11:24:30','Activo',20.00,NULL,1,'caja_chica_cheque'),(6,2,'2016-04-11',1000.00,'Cargo','2016-04-11 11:45:03','Activo',0.00,NULL,1,'caja_chica_cheque'),(7,2,'2016-04-11',300.00,'Cargo','2016-04-11 11:46:16','Inactivo',0.00,NULL,1,'caja_chica_cheque'),(8,2,'2016-04-11',300.00,'Abono','2016-04-11 11:46:53','Activo',300.00,NULL,1,'caja_chica_cheque'),(9,2,'2016-04-11',50.00,'Abono','2016-04-11 11:50:32','Activo',50.00,NULL,1,'caja_chica_cheque'),(10,2,'2016-04-11',150.00,'Abono','2016-04-11 11:51:44','Activo',100.00,NULL,1,'caja_chica_cheque'),(11,2,'2016-04-11',50.00,'Cargo','2016-04-11 11:53:14','Activo',0.00,NULL,1,'caja_chica_cheque'),(13,1,'2016-04-11',2000.00,'Abono','2016-04-11 14:41:56','Activo',2000.00,'Cheque de Caja Chica No.23432',2,'caja_chica_cheque'),(14,3,'2016-04-11',5000.00,'Cargo','2016-04-11 14:43:29','Activo',5000.00,'Cheque de Caja Chica No.er23424',3,'caja_chica_cheque'),(15,3,'2016-04-11',2500.00,'Cargo','2016-04-11 15:13:53','Inactivo',2500.00,'Cheque de Caja Chica No.232342',4,'caja_chica_cheque'),(16,3,'2016-04-11',3000.00,'Cargo','2016-04-11 15:32:53','Inactivo',3000.00,'Cheque de Caja Chica No.weqw',5,'caja_chica_cheque');
/*!40000 ALTER TABLE `caja_chica_detalle` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
BEGIN
    ...
    if new.tipo = 'Cargo' then
		update caja_chica set saldo = saldo + new.monto where idcaja_chica = new.idcaja_chica;
	else
		update caja_chica set saldo = saldo - new.monto where idcaja_chica = new.idcaja_chica;
	end if;
END */;;
...
BEGIN
    ...
    if new.estado != old.estado then
		if new.estado = 'Inactivo' then
			if new.tipo = 'Cargo' then
				update caja_chica set saldo = saldo-old.monto where idcaja_chica = new.idcaja_chica;
			else
				update caja_chica set saldo = saldo+old.monto where idcaja_chica = new.idcaja_chica;
			end if;
        else 
    ...
    if new.estado = 'Activo' then
		if new.monto != old.monto then
			if new.tipo = 'Cargo' then
				update caja_chica set saldo = saldo + (new.monto-old.monto) where idcaja_chica = new.idcaja_chica;
			else
				update caja_chica set saldo = saldo - (new.monto-old.monto) where idcaja_chica = new.idcaja_chica;
			end if;
		end if;
		if new.monto_aplicado > new.monto then
			set new.monto_aplicado = new.monto;
		end if;
		...
		set new.monto = old.monto;
		set new.monto_aplicado = old.monto_aplicado;
	end if;
    if old.fecha_insercion != new.fecha_insercion then
		set new.fecha_insercion = old.fecha_insercion;
    end if;
...
INSERT INTO `configuracion` VALUES (1,'codigo_cliente','codigo_prefijo','C','Activo',1),(2,'codigo_empleado','codigo_prefijo','E','Activo',1),(3,'codigo_proveedor','codigo_prefijo','0','Activo',1);
...
INSERT INTO `correlativo` VALUES (1,'codigo_cliente',8,1),(2,'codigo_cliente2',5,1),(3,'codigo_empleado',6,1),(4,'codigo_proveedor',1,1);
...
--
-- Table structure for table `documento_caja_chica`
--

DROP TABLE IF EXISTS `documento_caja_chica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `documento_caja_chica` (
  `iddocumento_caja_chica` int(11) NOT NULL AUTO_INCREMENT,
  `tipo` enum('Cargo','Abono') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Abono',
  `monto` decimal(10,2) NOT NULL DEFAULT '0.00',
  `fecha` date NOT NULL,
  `serie` varchar(64) COLLATE utf8_spanish_ci NOT NULL,
  `numero` varchar(64) COLLATE utf8_spanish_ci NOT NULL,
  `idtipo_documento` int(11) NOT NULL DEFAULT '1',
  `idcaja_chica` int(11) NOT NULL DEFAULT '1',
  `estado` enum('Activo','Inactivo') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Activo',
  `fecha_insercion` datetime DEFAULT NULL,
  PRIMARY KEY (`iddocumento_caja_chica`),
  KEY `fk_documento_caja_chica_idtipo_documento_idx` (`idtipo_documento`),
  KEY `fk_documento_caja_chica_idcaja_chica_idx` (`idcaja_chica`),
  CONSTRAINT `fk_documento_caja_chica_idcaja_chica` FOREIGN KEY (`idcaja_chica`) REFERENCES `caja_chica` (`idcaja_chica`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_documento_caja_chica_idtipo_documento` FOREIGN KEY (`idtipo_documento`) REFERENCES `tipo_documento` (`idtipo_documento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `documento_caja_chica`
--

LOCK TABLES `documento_caja_chica` WRITE;
/*!40000 ALTER TABLE `documento_caja_chica` DISABLE KEYS */;
INSERT INTO `documento_caja_chica` VALUES (1,'Abono',20.00,'2016-04-05','PARQ14','81533',1,1,'Activo','2016-04-06 16:30:36'),(2,'Abono',350.00,'2016-04-11','prue','1',1,2,'Activo','2016-04-11 11:47:39'),(3,'Abono',100.00,'2016-04-11','prue','2',1,1,'Activo','2016-04-11 11:52:15');
/*!40000 ALTER TABLE `documento_caja_chica` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `empleado` (
  ...
  KEY `fk_empleado_idpersona_idx` (`idpersona`),
  KEY `fk_empleado_idempresa_idx` (`idempresa`),
  CONSTRAINT `fk_empleado_idempresa` FOREIGN KEY (`idempresa`) REFERENCES `empresa` (`idempresa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_empleado_idpersona` FOREIGN KEY (`idpersona`) REFERENCES `persona` (`idpersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empleado` VALUES (1,'Luz Maria','C/F','Zona 1',1,'2','Activo',1),(5,'Leonor Solorzano','C/F','Ciudad',1,'E6','Activo',1);
...
CREATE TABLE `encargado` (
  ...
  `idempleado` int(11) NOT NULL DEFAULT '1',
  `tabla` varchar(45) COLLATE utf8_spanish_ci NOT NULL DEFAULT 'caja_chica',
  `idreferencia` int(11) NOT NULL DEFAULT '1',
  ...
  KEY `fk_encargado_idempleado_idx` (`idempleado`),
  CONSTRAINT `fk_encargado_idempleado` FOREIGN KEY (`idempleado`) REFERENCES `empleado` (`idempleado`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `encargado` VALUES (1,1,'caja_chica',1,'2016-03-01 00:00:00','2016-04-06 12:03:27',NULL,'Inactivo'),(2,5,'caja_chica',1,'2016-04-06 12:03:27',NULL,'2016-04-06 12:03:27','Activo'),(3,1,'caja_chica',2,'2016-04-11 11:44:41',NULL,'2016-04-11 11:44:41','Activo'),(4,1,'caja_chica',3,'2016-04-11 14:43:09',NULL,'2016-04-11 14:43:09','Activo');
...
INSERT INTO `modulo` VALUES (1,'Caja Chica','Activo','2016-04-06 15:18:02');
...
INSERT INTO `proveedor` VALUES (6,'Edge Guatemala S.A.','4937376-5','Ciudad',1,'01','Activo','2016-04-06 14:08:00');
...
INSERT INTO `tipo_documento` VALUES (1,'Factura','Activo','2016-04-06 15:18:13');
...
--
-- Table structure for table `tipo_documento_modulo`
--

DROP TABLE IF EXISTS `tipo_documento_modulo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tipo_documento_modulo` (
  `idtipo_documento_modulo` int(11) NOT NULL AUTO_INCREMENT,
  `idtipo_documento` int(11) NOT NULL DEFAULT '1',
  `idmodulo` int(11) NOT NULL DEFAULT '1',
  `estado` enum('Activo','Inactivo') COLLATE utf8_spanish_ci NOT NULL DEFAULT 'Activo',
  `fecha_insercion` datetime DEFAULT NULL,
  PRIMARY KEY (`idtipo_documento_modulo`),
  KEY `fk_tipo_documento_modulo_idtipo_documento_idx` (`idtipo_documento`),
  KEY `fk_tipo_documento_modulo_idmodulo_idx` (`idmodulo`),
  CONSTRAINT `fk_tipo_documento_modulo_idmodulo` FOREIGN KEY (`idmodulo`) REFERENCES `modulo` (`idmodulo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tipo_documento_modulo_idtipo_documento` FOREIGN KEY (`idtipo_documento`) REFERENCES `tipo_documento` (`idtipo_documento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipo_documento_modulo`
--

LOCK TABLES `tipo_documento_modulo` WRITE;
/*!40000 ALTER TABLE `tipo_documento_modulo` DISABLE KEYS */;
INSERT INTO `tipo_documento_modulo` VALUES (1,1,1,'Activo','2016-04-06 15:19:18');
/*!40000 ALTER TABLE `tipo_documento_modulo` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
-- Dump completed on 2016-04-11 16:37:49
