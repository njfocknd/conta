...
INSERT INTO `balance_general` VALUES (1,1,1,10000.00,5000.00,4000.00,7000.00,4000.00,'Activo',NULL);
...
CREATE TABLE `balance_general_detalle` (
  ...
  `idcuenta_mayor_principal` int(11) NOT NULL DEFAULT '6',
  ...
  KEY `fk_balance_general_detalle_idcuenta_mayor_principal_idx` (`idcuenta_mayor_principal`),
  ...
  CONSTRAINT `fk_balance_general_detalle_idcuenta_mayor_principal` FOREIGN KEY (`idcuenta_mayor_principal`) REFERENCES `cuenta_mayor_principal` (`idcuenta_mayor_principal`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `balance_general_detalle` VALUES (2,1,1,1,6,6,10000.00,'Activo',NULL),(3,1,1,2,10,40,5000.00,'Activo',NULL),(4,1,3,4,17,81,4000.00,'Activo',NULL),(5,1,3,5,19,99,7000.00,'Activo',NULL);
...
-- Dump completed on 2016-06-13 20:32:58
