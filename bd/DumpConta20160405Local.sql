...
INSERT INTO `caja_chica` VALUES (1,'Caja TI',5,NULL,'Activo',1,3,85.00);
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `contable`.`caja_chica_detalle_AFTER_INSERT` AFTER INSERT ON `caja_chica_detalle` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-04-06 14:38:36
